...
The iterative methods for Vecchia-Laplace approximations are implemented in the package GPBoost: https://github.com/fabsig/GPBoost. Release v1.2.5 is recommended for reproducibility of the results in the paper.
