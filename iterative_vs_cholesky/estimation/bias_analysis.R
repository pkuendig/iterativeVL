...
res_cols <- c("n", "time_estimation", "sigma2", "rho", "num_optim_iter")
...
for(n in 1:length(N)){
  for(r in 1:n_rep){
    ...
    results_Sigma_inv_plus_BtWB$time_estimation[i] <- system.time(model_Sigma_inv_plus_BtWB$fit(y=y_train))[3]
